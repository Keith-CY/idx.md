...
summary: >-
  ...
  - Added `debug` and `debugFile` options for programmatic control of debug
  logging

  - Added optional `pages` field to `FileReadToolInput` for reading specific PDF
  page ranges

  - Added `parts` output type to `FileReadToolOutput` for page-extracted PDF
  results
...
retrieved_at: 2026-02-05T09:48:58.764Z
