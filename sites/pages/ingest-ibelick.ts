...
const OUTPUT_PATH = resolve(repoRoot, "sources", "ibelick.yml");
const REPORT_DIR = resolve(DATA_ROOT, "reports");
const REPORT_PATH = resolve(DATA_ROOT, "reports", "ingest-ibelick.md");
const SOURCE_TYPE = "skills";
const BASE_TAGS = ["ibelick", "source-ibelick-ui-skills"] as const;
const HEADER = `# Schema: list of source entries\n# - type: string\n#   slug: string\n#   source_url: string\n#   title: string (optional)\n#   summary: string (optional)\n#   tags: [string] (optional)\n#   license: string (optional)\n#   upstream_ref: string (optional)\n`;

const REPO_API = "https://api.github.com/repos/ibelick/ui-skills";
const TREE_API = "https://api.github.com/repos/ibelick/ui-skills/git/trees";
const REPO_HTML = "https://github.com/ibelick/ui-skills";
...
console.log(`iBelick paths scanned: ${stats.totalPaths}`);
console.log(`iBelick entries written: ${entries.length}`);
