...
const OUTPUT_PATH = resolve(repoRoot, "sources", "openai.yml");
const REPORT_DIR = resolve(DATA_ROOT, "reports");
const REPORT_PATH = resolve(DATA_ROOT, "reports", "ingest-openai.md");
const SOURCE_TYPE = "skills";
const BASE_TAGS = ["openai", "source-openai-skills"] as const;
const HEADER = `# Schema: list of source entries\n# - type: string\n#   slug: string\n#   source_url: string\n#   title: string (optional)\n#   summary: string (optional)\n#   tags: [string] (optional)\n#   license: string (optional)\n#   upstream_ref: string (optional)\n`;

const REPO_API = "https://api.github.com/repos/openai/skills";
const TREE_API = "https://api.github.com/repos/openai/skills/git/trees";
const REPO_HTML = "https://github.com/openai/skills";
...
console.log(`OpenAI paths scanned: ${stats.totalPaths}`);
console.log(`OpenAI entries written: ${entries.length}`);
